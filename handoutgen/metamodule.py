from libcst import (CSTVisitor, CSTTransformer, RemovalSentinel,
                    ...
                    BaseStatement, Decorator, Name,
                    TrailingWhitespace, Comment, parse_module,
...
from handoutgen.libcst_utils import children
from typing import Iterable, Optional, List, Union, Sequence, TYPE_CHECKING
if TYPE_CHECKING:
    from handoutgen.metatraversers import MetaTraverser
...
class MetaModule:
    ...
    def task_funcs(self) -> Sequence[FunctionDef]:
        ...
        mchr = m.FunctionDef(decorators=[
            m.AtLeastN(self.qname_matcher_prov('handoutgen.HOMEWORK'), n=1)])
