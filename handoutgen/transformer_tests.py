...
from libcst import (
    FlattenSentinel, parse_expression, ClassDef, Element, Return, CSTTransformer,
    BaseExpression, Name, SimpleString, Attribute, Tuple, If,
...
from handoutgen.metatraversers import MetaTransformer, HyperTraverser
from handoutgen.metamodule import MetaModule
from handoutgen.libcst_utils import (params_as_tuple, NameReplacer, elem_iter,
                                     as_attribute)
