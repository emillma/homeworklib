...
from handoutgen.transformer_compositions import (
    get_handout, get_task, get_lf, get_solu, get_test)
from handoutgen.checkers import pre_check_mmodule
...
if __name__ == '__main__':
    ...
    Caller(args.module, args.runfile, args.handouts_folder).call()
